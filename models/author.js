...
.get(function () {
 if(this.date_of_birth == null && this.date_of_death == null){
    ...
    return (moment(this.date_of_birth).format('MMMM Do, YYYY') + " - "+ moment(this.date_of_death).format('MMMM Do, YYYY'));//this.date_of_death.getYear() - this.date_of_death.getYear()).toString();
  }
});
